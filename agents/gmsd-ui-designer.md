...
|-------|---------------|------------|
| **Researcher** | Discovery, analysis, context | /gmsd:init, inspiration analysis |
| **Specifier** | Specifications, wireframes | /gmsd:design-screens, /gmsd:define-components |
| **Prompter** | Prompts, exports, handoffs | /gmsd:export, prompt refinement |
| **Brander** | Logo, favicon, brand identity | /gmsd:logo, brand requests |
...
|---------|---------------|----------|
| `/gmsd:init` | Researcher | Coordinator |
| `/gmsd:setup-tokens` | Coordinator + Researcher | Coordinator |
| `/gmsd:design-screens` | Specifier | Coordinator |
| `/gmsd:define-components` | Specifier | Coordinator |
| `/gmsd:export [service]` | Prompter | Coordinator |
| `/gmsd:import-tokens` | Coordinator | - |
| `/gmsd:import-design` | Coordinator + Researcher | Coordinator |
| `/gmsd:realize` | Coordinator | - |
| `/gmsd:ui-sync` | Coordinator + Specifier | Coordinator |
| `/gmsd:ui-status` | Coordinator | - |
| `/gmsd:decisions` | Coordinator | - |
| `/gmsd:patterns` | Specifier | Coordinator |
| `/gmsd:logo` | Brander | Coordinator |
| `/gmsd:help` | Coordinator | - |
| `/gmsd:help` | Coordinator | - |
...
```markdown
## /gmsd:realize, /gmsd:import-design
...
- `/gmsd:design-screens` with complex requirements
- `/gmsd:define-components` with many screens
...
Recommended Next:
  ...
  → Run: /gmsd:design-screens SCR-03
...
|---------|----------------------|
| `/gmsd:init` | `docs(ui): initialize UI context for {project}` |
| `/gmsd:setup-tokens` | `feat(ui): establish design token system` |
| `/gmsd:design-screens` | `docs(ui): specify {SCR-XX} {name} screen` |
| `/gmsd:define-components` | `docs(ui): define component inventory` |
| `/gmsd:export` | `docs(ui): export {service} prompts for {screens}` |
| `/gmsd:realize` | `docs(ui): mark {SCR-XX} as realized` |
| `/gmsd:ui-sync` | `fix(ui): sync drift in {affected}` |
| `/gmsd:decisions` | `docs(ui): add design decision {DEC-XX}` |
| `/gmsd:patterns` | `docs(ui): add UI pattern {PAT-XX}` |
