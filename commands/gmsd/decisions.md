...
```
/gmsd:decisions              → View recent decisions
/gmsd:decisions view         → View all decisions
/gmsd:decisions add          → Add new decision
/gmsd:decisions filter       → Filter decisions
/gmsd:decisions DEC-005      → View specific decision
```
</step>
...
View specific: /gmsd:decisions DEC-005
Add new:       /gmsd:decisions add
Filter:        /gmsd:decisions filter --category=tokens
...
**By category:**
```
/gmsd:decisions filter --category=tokens
...
**By date:**
```
/gmsd:decisions filter --since=2026-01-18
...
**By screen:**
```
/gmsd:decisions filter --screen=SCR-01
...
Quick Actions:
  /gmsd:decisions add          Add new decision
  /gmsd:decisions DEC-XXX      View specific decision
  /gmsd:decisions filter       Search decisions
