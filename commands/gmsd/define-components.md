...
agent: gmsd-ui-specifier (for complex extraction)
---
...
1. **Check for screen specifications:**
   ...
   - If none found, prompt to run `/gmsd:design-screens` first
...
Please run: /gmsd:design-screens
...
Last updated: [date]
Generated by: /gmsd:define-components
...
`/gmsd:export stitch`    Visual design generation
`/gmsd:export v0`        React component generation
`/gmsd:export figma`     Figma setup + tokens
