---
name: gmsd:generate-specs
description: Auto-generate UI specs from code analysis (after /gmsd:scan)
allowed-tools: [Read, Write, Edit, Glob, Grep, AskUserQuestion, Task]
agent: gmsd-ui-specifier
---

<objective>
Generate UI specifications from the CODE-ANALYSIS.md created by `/gmsd:scan`. Auto-creates screen specs, COMPONENTS.md, and UI-SPEC.md based on discovered components and screens. This bridges the gap between codebase analysis and design tool export.

**Use case:** After reviewing `/gmsd:scan` results, auto-generate formal specs ready for export.
</objective>

<context>
@~/.claude/get-more-shit-done/ui-design/templates/screen.md
@~/.claude/get-more-shit-done/ui-design/templates/component.md
...
1. **Require CODE-ANALYSIS.md:**
   ...
   if not exists .planning/CODE-ANALYSIS.md:
     "No code analysis found. Run /gmsd:scan first."
     exit
   ```
...
*Auto-generated by /gmsd:generate-specs | Review recommended*
```
</step>
