...
agent: gmsd-ui-specifier (for pattern extraction)
---
...
```
/gmsd:patterns              → View pattern inventory
/gmsd:patterns view         → View all patterns
/gmsd:patterns add          → Add new pattern manually
/gmsd:patterns extract      → Auto-extract from screens
/gmsd:patterns PAT-01       → View specific pattern
```
</step>
...
View specific: /gmsd:patterns PAT-01
Add pattern:   /gmsd:patterns add
Auto-extract:  /gmsd:patterns extract
...
Quick Actions:
  /gmsd:patterns add          Add new pattern
  /gmsd:patterns extract      Auto-extract from screens
  /gmsd:patterns PAT-XX       View specific pattern
...
Review extracted patterns for accuracy:
  /gmsd:patterns PAT-06
  /gmsd:patterns PAT-07
