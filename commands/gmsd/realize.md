...
- `/gmsd:realize SCR-01` — Mark as done
- `/gmsd:realize SCR-01 --partial` — Partially done
- `/gmsd:realize SCR-01 --blocked` — Blocked on something

## Batch Operations

Allow marking multiple screens:
- `/gmsd:realize SCR-01,SCR-02,SCR-03`
- `/gmsd:realize all` — Interactive selection
</ux_principles>
...
- Major changes (consider /gmsd:import-design)
- Blocked on [issue]
</step>
...
`/gmsd:export v0 SCR-04` — Regenerate for missing parts
...
[If all done]
**Check for drift:**
`/gmsd:ui-sync` — Verify specs match reality
