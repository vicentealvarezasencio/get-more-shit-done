...
**This combines:**
- `/gmsd:scan` — Codebase analysis
- `/gmsd:generate-specs` — Spec generation
- `/gmsd:export` — Export preparation
</objective>

<context>
@~/.claude/get-more-shit-done/ui-design/templates/code-analysis.md
@~/.claude/get-more-shit-done/ui-design/templates/screen.md
@~/.claude/get-more-shit-done/ui-design/templates/ui-spec.md
@~/.claude/get-more-shit-done/agents/gmsd-ui-scanner.md
@~/.claude/get-more-shit-done/ui-design/adapters/stitch.md
@~/.claude/get-more-shit-done/ui-design/adapters/v0.md
@~/.claude/get-more-shit-done/ui-design/adapters/figma.md
</context>
...
Execute full `/gmsd:scan` process:
...
Execute full `/gmsd:generate-specs` process:
...
- Suggest running `/gmsd:scan` manually with debug

## If Generation Fails

- Keep scan results
- Report which specs failed
- Suggest running `/gmsd:generate-specs` manually

## If Export Fails

- Keep scan and spec results
- Report export error
- Suggest running `/gmsd:export` manually
</error_handling>
