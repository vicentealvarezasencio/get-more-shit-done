...
```bash
PHASE_INFO=$(node /Users/vinsanity23/.claude/get-more-shit-done/bin/gmsd-tools.js find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/vinsanity23/.claude/get-more-shit-done/bin/gmsd-tools.js roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/vinsanity23/.claude/get-more-shit-done/bin/gmsd-tools.js find-phase "${PHASE}" --raw)
```
