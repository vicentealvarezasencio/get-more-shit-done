...
| Event | Commit? | Type |
|-------|---------|------|
| `/gmsd:init` completes | Yes | `docs(ui)` |
| `/gmsd:setup-tokens` completes | Yes | `feat(ui)` |
| `/gmsd:design-screens` creates/updates screen | Yes | `docs(ui)` |
| `/gmsd:define-components` completes | Yes | `docs(ui)` |
| `/gmsd:export` generates prompts | Yes | `docs(ui)` |
| `/gmsd:realize` marks screen realized | Yes | `docs(ui)` |
| `/gmsd:ui-sync` fixes drift | Yes | `fix(ui)` |
| `/gmsd:decisions` adds decision | Yes | `docs(ui)` |
| `/gmsd:patterns` adds pattern | Yes | `docs(ui)` |
| `/gmsd:import-tokens` imports tokens | Yes | `feat(ui)` |
| `/gmsd:import-design` syncs designs | Yes | `docs(ui)` |
...
# After /gmsd:design-screens (single screen)
...
# After /gmsd:design-screens (multiple screens)
