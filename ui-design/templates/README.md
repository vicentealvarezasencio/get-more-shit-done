...
This folder contains templates for all UI specification documents created by the `/gmsd:*` commands.
...
- `/gmsd:help` — Show all available commands
- `~/.claude/get-more-shit-done/ui-design/README.md` — Full documentation
